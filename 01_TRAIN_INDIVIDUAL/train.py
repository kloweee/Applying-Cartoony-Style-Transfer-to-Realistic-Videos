...
# initialization forces the generators to create copies of the input images (so real geneartor generating a real image) in order to force the networks to better understand the content of the images
def initialization(disc_R, disc_C, gen_C, gen_R, loader, opt_disc, opt_gen, l1, mse, d_scaler, g_scaler):
    ...
    for idx, (cartoon, real, blurry) in enumerate(loop):
        ...
        with torch.amp.autocast("cuda"):
            ...
            # RUN disc_C on blurry cartoon and add to d_c_loss
...
def main():
    ...
    # keep track of current epoch count
    epochs = 0
